...
| Cmd-K search | Grouped tokens/wallets/creators/transactions, address/hash detection, name/symbol matching, external fallback for unknown transactions | ENS resolution and persistent full-history search |
