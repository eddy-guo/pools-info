...
test("Postgres migrations, checkpoint atomicity, restart and canonical rewind", async (t) => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      "010_broad_swaps.sql",
      "011_broad_token_units.sql",
      "012_broad_market_rollups.sql",
      "013_sender_code_observations.sql",
      "015_token_images.sql",
      "016_recent_batch_source.sql",
      "017_aggregate.sql",
      "018_broad_market_bucket_extremes.sql",
      "019_token_total_supply.sql",
      "020_ledger_tip.sql",
