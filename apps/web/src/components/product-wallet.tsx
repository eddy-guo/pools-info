  ...
  return (
    <div className={`page ${styles.page}`}>
      ...
      <div className="stats-grid live-eight-stats">
        <Stat label="Realized PnL" note="Supported pool positions · before gas">
      ...
      {w && (
        <p className="page-intro-note">
          ...
          {w.excludedPositionCount} excluded positions. An excluded position is
          not assigned zero profit. Transfers and unsupported routes can make
          its cost basis unknown.
        </p>
      )}
      <div className="workspace-grid">
              ...
              <>
                    ...
                    <tbody>
                      {data?.trades.map((e) => (
                        ...
                        >
                          ...
                          <td>
                            {e.flags.length ? e.flags.join(", ") : "Supported"}
                          </td>
                          <td>
                            <a
                ...
                {data?.tradesTruncated && (
                  <p className="panel-footnote">
                    Showing a bounded trade list. Aggregate metrics use the full
                    saved histories.
                  </p>
                )}
              </>
        ...
        <aside className="market-sidebar">
          ...
          <section className="panel">
            ...
            <p className="panel-footnote">
              Holdings are marked at each pool’s saved cutoff. Spot marks are
              not guaranteed exit proceeds.
            </p>
          </section>
        </aside>
      </div>
